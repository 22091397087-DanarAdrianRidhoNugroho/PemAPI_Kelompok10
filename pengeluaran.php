...
<head>
    ...
    <title>Aplikasi Manajemen Keuangan - Pengeluaran</title>
...
<body>
    ...
    <div class="sidebar">
        <nav>
            <ul>
                <li>
                    <img src="img/user.jpg" class="img-fluid profile float-left" width="70px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="jumlahTambah" class="form-control" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" required>
                    </div>
                </div>
                <!-- footer form -->

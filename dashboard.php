...
<head>
    ...
    <title>Aplikasi Manajemen Keuangan - Dashboard</title>
...
<body>
    <div class="header">
        <h3 class="text-secondary font-weight-bold float-left logo">Aplikasi Manajemen Keuangan</h3>
        <a href="logout">
            <div class="logout">
    ...
    <div class="sidebar">
        <nav>
            <ul>
                <li class="rentang">
                    <img src="img/user.jpg" class="img-fluid profile float-left" width="70px" height="50px">
                ...
                <div class="container" id="container" style="border: none;">
                    <div class="row tampilCardview" id="row">
                        ...
                        <div class="col-md-4 jarak">
                            <div class="card card-stats card-warning" style="background: #4169E1;">
                                <div class="card-body ">
                                    <div class="row">
                                        <div class="col-5">
                        ...
                        <div class="col-md-4 jarak">
                            <a href="tambahPengeluaran" style="text-decoration: none;">
                                <div class="card card-stats card-warning" style="background: #DC143C;">
                                    <div class="card-body ">
                                        <div class="row">
                                            <div class="col-5">
                                                <div class="icon-big text-center">
                        ...
                        <div class="col-md-4 jarak">
                            <a href="tambahPemasukkan" style="text-decoration: none;">
                                <div class="card card-stats card-warning" style="background: #32CD32;">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-5">
                                                <div class="icon-big text-center">
